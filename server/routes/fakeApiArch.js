...
module.exports = function () {
  ...
  router.get('/api/arch', function (req, res) {
  ...
  router.post('/api/arch', function (req, res) {
    if (1) {
      res.json({
        data: {
          id: 123,
  ...
  router.put('/api/arch/:id', function (req, res) {
  ...
  router.delete('/api/arch/:ids', function (req, res) {
