...
module.exports = function () {
  ...
  router.get('/api/ncsync/config', function (req, res) {
    res.json({
      props: 'some props',
      root: {
        id: '0',
  ...
  router.get('/api/ncsync', function (req, res) {
  ...
  router.post('/api/ncsync', function (req, res) {
    if (1) {
      res.json({
        data: {
          id: 123,
  ...
  router.put('/api/ncsync/:id', function (req, res) {
  ...
  router.delete('/api/ncsync/:ids', function (req, res) {
